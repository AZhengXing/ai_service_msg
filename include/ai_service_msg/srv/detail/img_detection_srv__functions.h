...
#ifndef AI_SERVICE_MSG__SRV__DETAIL__IMG_DETECTION_SRV__FUNCTIONS_H_
#define AI_SERVICE_MSG__SRV__DETAIL__IMG_DETECTION_SRV__FUNCTIONS_H_
...
#include "ai_service_msg/msg/rosidl_generator_c__visibility_control.h"

#include "ai_service_msg/srv/detail/img_detection_srv__struct.h"

/// Initialize srv/IMGDetectionSrv message.
/**
...
/// Create srv/IMGDetectionSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ai_service_msg__srv__IMGDetectionSrv_Request__init().
...
/// Destroy srv/IMGDetectionSrv message.
/**
 * It calls
 * ai_service_msg__srv__IMGDetectionSrv_Request__fini()
...
/// Check for srv/IMGDetectionSrv message equality.
/**
...
/// Copy a srv/IMGDetectionSrv message.
/**
...
/// Initialize array of srv/IMGDetectionSrv messages.
/**
...
/// Finalize array of srv/IMGDetectionSrv messages.
/**
 * It calls
 * ai_service_msg__srv__IMGDetectionSrv_Request__fini()
...
/// Create array of srv/IMGDetectionSrv messages.
/**
 * It allocates the memory for the array and calls
 * ai_service_msg__srv__IMGDetectionSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/IMGDetectionSrv messages.
/**
 * It calls
 * ai_service_msg__srv__IMGDetectionSrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/IMGDetectionSrv message array equality.
/**
...
/// Copy an array of srv/IMGDetectionSrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ai_service_msg__srv__IMGDetectionSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ai_service_msg
...
/**
 * It calls
 * ai_service_msg__srv__IMGDetectionSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ai_service_msg
...
/**
 * It allocates the memory for the array and calls
 * ai_service_msg__srv__IMGDetectionSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ai_service_msg
...
/**
 * It calls
 * ai_service_msg__srv__IMGDetectionSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AI_SERVICE_MSG__SRV__DETAIL__IMG_DETECTION_SRV__FUNCTIONS_H_
